<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="获奖学生" prop="awardStudents">
        <el-input
          v-model="queryParams.awardStudents"
          placeholder="请输入获奖学生"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['result:awardStudent:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['result:awardStudent:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['result:awardStudent:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['result:awardStudent:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="awardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="奖项ID" align="center" prop="id" />
      <el-table-column label="比赛名称" align="center" prop="competitionName" />
      <el-table-column label="获奖学生" align="center" prop="awardStudents" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="获奖学生" prop="awardStudents">
          <el-input v-model="form.awardStudents" placeholder="请输入获奖学生" />
        </el-form-item>
        <el-form-item label="本人排名" prop="authorRank">
...
<script>
import { listAward, getAward, delAward, addAward, updateAward } from "@/api/result/awardStudent";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        awardStudents: [
          { required: true, message: "获奖学生不能为空", trigger: "blur" }
        ],
        authorRank: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学生获奖信息编号为"' + ids + '"的数据项？').then(function() {
        return delAward(ids);
      }).then(() => {
        this.getList();
