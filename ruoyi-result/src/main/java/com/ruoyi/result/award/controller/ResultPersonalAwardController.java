package com.ruoyi.result.award.controller;
...
public class ResultPersonalAwardController extends BaseController
{
     ...
     * 查询个人获奖列表
     */
    @PreAuthorize("@ss.hasPermi('result:award:list')")
    @GetMapping("/list")
     ...
     * 导出个人获奖列表
     */
    @PreAuthorize("@ss.hasPermi('result:award:export')")
     ...
     * 获取个人获奖详细信息
     */
    @PreAuthorize("@ss.hasPermi('result:award:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增个人获奖
     */
    @PreAuthorize("@ss.hasPermi('result:award:add')")
     ...
     * 修改个人获奖
     */
    @PreAuthorize("@ss.hasPermi('result:award:edit')")
     ...
     * 删除个人获奖
     */
    @PreAuthorize("@ss.hasPermi('result:award:remove')")
